...
<title>TAKASHIMURA Catering | Administrator</title>
<?php if($_POST): ?>
<?php else: ?>
        	...
        	<div class="titlenav">Main Menu</div>
                <ul class="navigation">
                    ...
                    <li><a href="javascript:void(0);"><span>Data Master</span></a>
                        <ul>
                            <li><a href="?p=bahan"><span>Data Bahan Baku</span></a></li>
                            <li><a href="?p=roti"><span>Data Master Roti</span></a></li>
                        </ul>
                    </li>
                    
                    <li><a href="javascript:void(0);"><span>Data Transaksi</span></a>
                        <ul>
                            <li><a href="?p=#"><span>Data Roti</span></a></li>
                            <li><a href="?p=category"><span>Data Pembelian Roti</span></a></li>
                        </ul>
                    </li>
